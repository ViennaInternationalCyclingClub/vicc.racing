...
my @race_columns = ('Rider ID','Race ID','Participation Status','Race Start Date','Race Title','Combined Race Title','Rider',
    'Participation Status Short','Sortable Combined Race Title','Race Type','Race Subtype','StravaID','StartDateISO8661','EndDateISO8661');
...
my $strava_gsheet_column_index_start = 16;
